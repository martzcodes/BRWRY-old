# Django settings for BRWRY_django project.
...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/martz/tutorialproject/BRWRY_django/BRWRY.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(SETTINGS_ROOT, "data/")
...
ROOT_URLCONF = 'BRWRY_django.urls'
